                ...
                <v-col cols="12">
                    ...
                    <v-col>
                        ...
                        <v-row justify="center">
                            <v-col v-for="(ability, index) in pokemonDetail.types"
                                   :key="index"
                                   class="py-0"
                                   cols="auto">
                                <v-chip
...
<script>
    import AbilityStat from "@/components/PokemonsDetail/AbilityStat"
    import PokeMoves from "@/components/PokemonsDetail/PokeMoves"
